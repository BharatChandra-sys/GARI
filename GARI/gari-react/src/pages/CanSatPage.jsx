...
const CanSatPage = () => {
  ...
  const timeline = [
    { phase: 'Phase 1', title: 'PDR — Preliminary Design Review', status: 'In Progress', desc: 'System architecture, subsystem definitions, and design approach under review and development.' },
    { phase: 'Phase 2', title: 'CDR — Critical Design Review', status: 'Upcoming', desc: 'Detailed design, manufacturing drawings, and test plans. Follows PDR completion.' },
    ...
    { phase: 'Phase 4', title: 'Launch — IN-SPACe CAN-7USAT 2026', status: 'Upcoming', desc: 'Competition launch at 1000m altitude, Nov 17-20, 2026 at Kushinagar. Full mission execution with live telemetry.' },
  ];
  ...
  return (
    <div className="cansat-page">
      <SEO
        ...
        description="GARI's CanSat: 330ml student satellite with NavIC GNSS, 1000m launch altitude, real-time RF telemetry, dual parachute recovery, and 8 subsystems. PDR in progress. Competing in IN-SPACe CAN-7USAT 2026 — India's national student CanSat competition. Built at GITAM University Hyderabad."
        path="/cansat"
        ...
        faq={[
          ...
          { q: 'What is the status of GARI CanSat PDR?', a: 'GARI CanSat PDR (Preliminary Design Review) is currently in progress. The team is developing system architecture and subsystem definitions for formal review.' },
