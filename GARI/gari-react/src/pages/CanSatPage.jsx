...
const CanSatPage = () => {
  ...
  const timeline = [
    ...
    { phase: 'Phase 2', title: 'CDR — Critical Design Review', status: 'In Progress', desc: 'Detailed design, manufacturing drawings, and test plans currently under development.' },
  ...
  return (
    <div className="cansat-page">
      <SEO
        ...
        description="GARI's CanSat: 330ml student satellite with NavIC GNSS, 1000m launch altitude, real-time RF telemetry, dual parachute recovery, and 8 subsystems. PDR cleared, CDR in progress. Competing in IN-SPACe CAN-7USAT 2026 — India's national student CanSat competition. Built at GITAM University Hyderabad."
        path="/cansat"
        ...
        faq={[
          ...
          { q: 'Has GARI cleared PDR for its CanSat?', a: 'Yes. GARI has successfully cleared the Preliminary Design Review (PDR) for the CanSat program. CDR (Critical Design Review) is currently in progress with detailed design and manufacturing specifications under development.' },
